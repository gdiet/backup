...
as "linking" for the purposes of the license below, even though there's no
build-time dependency on WinFSP (no import library, nothing declared in
...
full since it's the reason the Windows mount feature is legally viable at
all:
...
This project satisfies all three conditions: it's MIT/Apache-2.0
(satisfies both the [FSD] and the [OSD]), carries the required copyright
notice and repository link right here and in the [README](README.md), and
doesn't bundle any proprietary software.

> WinFsp - Windows File System Proxy, Copyright (C) Bill Zissimopoulos
> https://github.com/winfsp/winfsp

See also [`mountfs/vendor/winfsp/NOTICE.md`](mountfs/vendor/winfsp/NOTICE.md)
for the vendored WinFSP header copies used as a struct-layout reference.
