...
case class FileSysViewReadOnly(readAccess: RepositoryReadOnly) extends FileSystemView {
  protected val repoFiles = new RepoFiles(readAccess, None)
  import repoFiles._

  protected val writeAccess: Option[Repository] = None
