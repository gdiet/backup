 ...
 * under the License.
 */
package net.diet_rich.dedup.webdav; // *project specific*
...
//import io.milton.http.annotated.AnnotationResourceFactory; // *project specific*
//import io.milton.http.template.JspViewResolver; // *project specific*
//import io.milton.http.template.ViewResolver; // *project specific*
import io.milton.http.webdav.WebDavResponseHandler;
import io.milton.servlet.*; // *project specific*
 ...
 * @author brad
 * 
 * based on milton-server-ce-2.5.2.5.jar
 * changes for this project marked with // *project specific*
 */
public class LocalMiltonConfigurator implements MiltonConfigurator { // *project specific*
    ...
    // *project specific* (END)
        try {
            ...
            Class<?> builderClass = Class.forName("io.milton.ent.config.HttpManagerBuilderEnt"); // *project specific*
...
//        ResourceFactory rf = builder.getMainResourceFactory();  *project specific*
...
//      }
    ...
    private void checkAddInitable(List<Initable> initables, Object o) {
        if (o instanceof Initable) {
            ...
            for (Object o2 : (List<?>) o) { // *project specific*
