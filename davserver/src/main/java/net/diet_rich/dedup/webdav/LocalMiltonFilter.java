 ...
 */
public class LocalMiltonFilter implements javax.servlet.Filter { // *project specific*
    ...
    private static final Logger log = LoggerFactory.getLogger(LocalMiltonFilter.class); // *project specific*
    private FilterConfigWrapper config;
    private ServletContext servletContext;
    protected HttpManager httpManager;
//    protected MiltonConfigurator configurator;  *project specific*
    /**
