...
import CachedDataFileInternalTests._

class CachedDataFileInternalTests extends CachedDataFile(testOffset, testLength, testFile) {
...
object CachedDataFileInternalTests {
