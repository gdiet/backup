...
/** Internal size limit for byte arrays. Set to less than 0.5 MiB to avoid problems with humongous objects
  * in G1GC and to a power of 2 so blocks align well if the fuse layer uses blocks sized a smaller power of 2.
  * Long story short, 2 <<< 17 is a good value.
  *
...
val memChunk = 2 << 17 // TODO add check at startup that simply allocates 90% of the free memory with chunks
