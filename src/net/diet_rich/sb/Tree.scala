...
// part of a planned high level API
...
//  def make(id: Long, child: String) : Option[Long] = treeDb.create(id, child)
//
...
//
//  /** @return the entry, None if no such node. */
//  def entry(id: Long) : Option[TreeEntry] = treeDb entry id
//
...
//  def children(id: Long) : Iterable[TreeEntry] = treeDb children id
//
...
//  def deleteWithChildren(id: Long) : Boolean = treeDb deleteWithChildren id
//}
//
//object Tree {
//
