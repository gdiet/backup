...
def readableBytes(l: Long): String =
  if      l < 10_000             then "%d B"    .format(l)
  else if l < 1_000_000          then "%,.2f kB".format(l/1_000d)
  else if l < 1_000_000_000      then "%,.2f MB".format(l/1_000_000d)
  else if l < 1_000_000_000_000L then "%,.2f GB".format(l/1_000_000_000d)
  else                                "%,.2f TB".format(l/1_000_000_000_000d)
