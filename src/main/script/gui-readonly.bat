...
start "DedupFS" %JAVAW% "-DLOG_BASE=%~dp0log" -Xmx80m -Dfile.encoding=UTF-8 -Dlogback.configurationFile=logback-server.xml -cp "%~dp0lib\*" dedup.mount gui=true readOnly=true %*
