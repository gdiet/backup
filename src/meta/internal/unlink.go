...
// // Returns ErrNotEmpty if trying to delete a non-empty directory.
// func Unlink(tree, children, data, freeAreas *bbolt.Bucket, id []byte) error {

// 	entry, err := treeEntry(tree, id)
// 	if err != nil {
// 		return err
// 	}
...
// 		fileEntry := entry
// 		err := releaseDataReference(data, freeAreas, fileEntry.dref)
// 		if err != nil {
// 			return err
// 		}
// 	}
...
// // releaseDataReference decrements the reference count for a data entry and frees it if count reaches zero
// func releaseDataReference(data, freeAreas *bbolt.Bucket, dref [40]byte) error {
