...
func TestRemoveOverlappingAreas(t *testing.T) {
	...
	t.Run("NoOverlaps", func(t *testing.T) {
		...
		area := DataArea{Off: 6, Len: 3} // [6-9) - no overlap with any area
		result := areas.RemoveOverlappingAreas(area)
		expected := areas
	...
	t.Run("CompleteOverlap", func(t *testing.T) {
		...
		area := DataArea{Off: 8, Len: 10} // [8-18) - completely contains [10-15)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},
			{Off: 20, Len: 5},
	...
	t.Run("PartialOverlapStart", func(t *testing.T) {
		...
		area := DataArea{Off: 10, Len: 2} // [10-12) - partial overlap at start
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
	...
	t.Run("PartialOverlapEnd", func(t *testing.T) {
		...
		area := DataArea{Off: 18, Len: 4} // [18-22) - partial overlap at end
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},  // [0-5) - unchanged
	...
	t.Run("PartialOverlapMiddle", func(t *testing.T) {
		...
		area := DataArea{Off: 5, Len: 10} // [5-15) - overlaps middle of [0-20)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
	...
	t.Run("MultipleOverlaps", func(t *testing.T) {
		...
		area := DataArea{Off: 8, Len: 10} // [8-18) - overlaps with [10-15) and [16-18)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},
	...
	t.Run("ExactMatch", func(t *testing.T) {
		...
		area := DataArea{Off: 10, Len: 5} // [10-15) - exact match
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},
			{Off: 20, Len: 5},
	...
	t.Run("OverlapAll", func(t *testing.T) {
		...
		area := DataArea{Off: 0, Len: 35} // [0-35) - overlaps with all areas
		result := areas.RemoveOverlappingAreas(area)
	...
	t.Run("UnsortedInput", func(t *testing.T) {
		...
		area := DataArea{Off: 8, Len: 7} // [8-15) - overlaps with [10-15)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
	...
	t.Run("OverlappingInput", func(t *testing.T) {
		...
		area := DataArea{Off: 2, Len: 3} // [2-5) - overlaps with both [0-5) and [3-7)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
	...
	t.Run("AdjacentAreas", func(t *testing.T) {
		...
		area := DataArea{Off: 3, Len: 4} // [3-7) - overlaps with both [0-5) and [5-10)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
	...
	t.Run("ZeroLengthAreas", func(t *testing.T) {
		...
		area := DataArea{Off: 8, Len: 4} // [8-12) - contains point 10
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},  // [0-5) - unchanged
			{Off: 15, Len: 5}, // [15-20) - unchanged
	...
	t.Run("ZeroLengthRemovalArea", func(t *testing.T) {
		...
		area := DataArea{Off: 15, Len: 0} // [15-15) - zero-length area (point 15)
		result := areas.RemoveOverlappingAreas(area)
		expected := DataAreas{
			{Off: 0, Len: 5},  // [0-5) - unchanged
