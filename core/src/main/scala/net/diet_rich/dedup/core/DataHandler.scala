...
class DataHandler(dataBackend: DataBackendInterface, storeSettings: StoreSettings, tables: sql.Tables, freeRanges: RangesQueue) extends DataHandlerInterface {
