...
func NewRepositorySettings(cdcTargetSizeBits uint, chunking string) RepositorySettings {
...
func NewRepositorySettingsFrom(settings map[string]string) RepositorySettings {
	...
	return NewRepositorySettings(uint(cdcTargetSizeBits), settings["chunking"])
}
