...
// | no chunk ends |  mask 1  |  mask 2  |   mask 3  | ...
// |   0  --  30   | 31 -- 62 | 63 -- 94 | 95 -- 126 | ...
// | min chunk size 32 |      | 32 bytes mask 2 |
//                 | 32 bytes mask 1 |   | 32 bytes mask 3 |

func (c *cdcChunker) Next(data []byte) []int {
	// Copying the struct fields to local vars does not help. With
	// Go 1.25.5 on Intel i7-1355U, it reduced performance by 5 % to 10 %.
	i := 0
	var chunkPositions []int
	//c.shiftMaskAt += c.chunkStart // TODO needed?
