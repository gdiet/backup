...
* DedupFS is open source, see its [GitHub repository](https://github.com/gdiet/backup). It consists of ~2000 lines of production code and depends only on a handful of libraries: ![dependencies](6.0.0%20dependency%20graph.png).
