...
# "Workload catalog". Reads back files file30kb-create.ps1 created, cycling through whichever
# range it has produced so far (run file30kb-create.ps1 first - this script only reads, it never
