...
# "Workload catalog". Reads back files file100b-create.sh created, cycling through whichever range
# it has produced so far (run file100b-create.sh first - this script only reads, it never grows
