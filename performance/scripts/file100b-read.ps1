...
# "Workload catalog". Reads back files file100b-create.ps1 created, picking a pseudo-randomly
# chosen existing file within whichever range it has produced so far (run file100b-create.ps1
