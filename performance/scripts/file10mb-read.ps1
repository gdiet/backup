...
# "Workload catalog". Reads back files file10mb-create.ps1 created, cycling through whichever range
# it has produced so far (run file10mb-create.ps1 first - this script only reads, it never grows
