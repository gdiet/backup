...
Raised while planning the FUSE mount (see `docs/plans/fuse-mount.md`, which this supersedes/details §3 of), but independent of it: our `store` command never reuses space freed by `reclaim-space`.
